export const FilterableMovieTable = React.createClass({
...
const MovieRow = React.createClass({
  render() {
    const color = this.props.movie.forChildren ? 'black' : 'red';
    return (
        <tr>
          <td><span style={{color: color}}>{this.props.movie.name}</span></td>
